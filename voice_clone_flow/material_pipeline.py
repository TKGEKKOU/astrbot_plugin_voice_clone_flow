...
class MaterialPipeline:
    def __init__(self, context, provider_id: str, ffmpeg_path: str, model_path: Path, sessions_dir: Path) -> None:
    ...
    async def run(self, task_id: str, source: Path, language: str, transition) -> list[dict[str, object]]:
        ...
        backend = AstrBotSTTBackend(self.context, self.provider_id)
